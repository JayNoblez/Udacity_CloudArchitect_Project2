...
data "archive_file" "lambda_zip" {
  type        = "zip"
  source_file = "${path.module}/hellofunc_Lambda.py"
  output_path = "${path.module}/script.zip"
}

resource "aws_lambda_function" "funchello_lambda" {
  description      = "Python Lambda function returning a 'Hello' once triggered"
